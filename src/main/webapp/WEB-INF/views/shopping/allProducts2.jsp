                           ...
                           <img class="card-img-top" src='picture/${product.shoppingId}' alt="${product.shoppingId}">
                                <div class="card-body card" >
                                 <h5 class="card-img-top" >${product.shoppingname}</h5>
                                     <h6 class="card-text text-danger">${product.shoppingProductPrice}</h6>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 mb-5">
                            ...
                            <c:forEach var='ShoppingCart' items='${ShoppingCart.content}' >
                             ...
                             <h6 class="d-inline-block">${ShoppingCart.value.shoppingProductName}</h6>
                                ...
                                <p class="d-block text-secondary pl-4">
                                    <span class="text-warning">${ShoppingCart.value.orderItemsNumber}</span>&nbsp;X&nbsp;NT${ShoppingCart.value.shoppingProductPrice}
                            ...
                            <div class="d-block mt-3 mb-3">
                                ...
                                <h5 class="text-center" >小計：NT$&nbsp;${ShoppingCart.subtotal}</h5>
                            </div>
                            <div class="d-block">
                                <a href="shoppingCart" class="btn btn-primary btn-block text-white" role="button">查看購物車</a>
                            </div>
